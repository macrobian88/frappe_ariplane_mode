...
//         });
//       });
//     } else if (frm.doc.invoice_generated && frm.doc.payment_status !== "Paid") {
//             frm.add_custom_button('Mark as Paid', () => {
//                 frappe.call({
//                     method: "airplane_mode.airplane_mode.doctype.contract_shop.contract_shop.mark_invoice_as_paid",
